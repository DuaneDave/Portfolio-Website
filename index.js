...
function createModal() {
  ...
  <p class="modal-content">${width < 1080 ? projects[0].description[0] : projects[0].description[1]}</p>
  <div class="modal-actions flex">
  <button class="special">
  <a href="${projects[0].link[0]}" class="flex">See live <img src="asset/see.png" /></a>
  </button>
  <button class="special flex"><a href="${projects[0].link[1]}" class="flex">See source <img src="asset/linkgit.png" /></a>
  </button>
  </div>
  </div>
  </div>
