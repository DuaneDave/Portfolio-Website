...
const project = [
  {
    ...
    description: {
      summary: 'A daily selection of privately personalise reads; no accounts or sign-ups required. has been the industry standard',
...
function createModal(idx) {
  ...
  <p class="modal-content">${project[idx].description.small}</p>
  <div class="modal-actions flex">
  <button class="special">
  <a href="${project[idx].link.seeLive}" class="flex">See live <img src="asset/see.png" /></a>
  </button>
  <button class="special flex"><a href="${project[idx].link.sources}" class="flex">See source <img src="asset/linkgit.png" /></a>
  </button>
  </div>
  </div>
  </div>
